...
class _EditUserProfileState extends State<EditUserProfile> {
  ...
  TextEditingController academicFieldController = TextEditingController();
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                              child: snapshot.data!.role == "dosen" ? lectureForm() : userForm())
                        ],
                      ),
                    ),
                    SizedBox(
  ...
  Widget lectureForm(){
    return FutureBuilder<UserModel>(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            academicFieldController.text = snapshot.data!.academicField ?? '';
            majorController.text = snapshot.data!.major ?? '';
            organizationController.text = snapshot.data!.organization ?? '';
            ...
            return Column(
              children: [
                const Align(alignment: Alignment.topLeft, child: Text('Academic Field :')),
                const SizedBox(
                  height: 5,
                ),
                TextField(
                  controller: academicFieldController,
