                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              GestureDetector(
                                onTap: (){
                                  Navigator.push(context , MaterialPageRoute(builder: (context) => ArticleCardOpen(articleData: snapshot.data![index])),
                                  );
                                },
                                child: Column(
                                  children: [
                                    ...
                                    Align(
                                      ...
                                      child: Container(
                                        ...
                                        child: CustomMarkdownBody(data: snapshot.data![index].desc, maxLines: 2, shrinkWrap: true, overflow: TextOverflow.ellipsis,),
                                      ),
                                    ),
                                    Align(
                                      alignment: Alignment.topLeft,
