...
class FriendPersonalInformation extends StatefulWidget {
  ...
  @override
  State<FriendPersonalInformation> createState() =>
      _FriendPersonalInformationState(userId);
}
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                  ...
                                                  style: TextStyle(
                                                      ...
                                                      fontSize: 15)),
                                              Text(
                                                  'Academic Field : ${snapshot.data!.academicField}',
                                                  style: TextStyle(
                                                      fontWeight:
                                                          FontWeight.bold,
                                                      fontSize: 15)),
                                              ...
                                              Text(
                                                  ...
                                                  style: TextStyle(
                                                      ...
                                                      fontSize: 15)),
                                              Text(
                                                  'Date of Birth : ${snapshot.data!.dateBirth != null ? DateFormat.yMMMEd().format(DateTime.parse(snapshot.data!.dateBirth)) : ''}',
                                                  style: TextStyle(
                                                      fontWeight:
                                                          FontWeight.bold,
                                                      fontSize: 15)),
                                              Text(
                                                  'Gender : ${snapshot.data!.gender != null ? snapshot.data!.gender : ''}',
                                                  style: TextStyle(
                                                      fontWeight:
                                                          FontWeight.bold,
                                                      fontSize: 15)),
